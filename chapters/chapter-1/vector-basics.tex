\chapter{Vector Basics}
    ...
    \section{Curl and Divergence}
        Before we discuss Curl and Divergence, we define the $\nabla$ operator as:
        $$\nabla = \frac{\partial}{\partial x}\vec{a}_x + \frac{\partial}{\partial y}\vec{a}_y + \frac{\partial}{\partial z}\vec{a}_z$$
        \subsection{Divergence}
            Divergence of a vector field $\vec{F}$ is defined as:
            $$div(\vec{F})=\nabla\cdot\vec{F}$$
            $$div(\vec{F}) = \left(\frac{\partial}{\partial x}\vec{a}_x + \frac{\partial}{\partial y}\vec{a}_y + \frac{\partial}{\partial z}\vec{a}_z\right)\cdot\left(\vec{F}_x\vec{a}_x + \vec{F}_y\vec{a}_y + \vec{F}_z\vec{a}_z\right)$$
            Solving that we get:
            \begin{equation}\label{eq:divergenceequation}
                div(\vec{F}) = \frac{\partial F_x}{\partial x} + \frac{\partial F_y}{\partial y} + \frac{\partial F_z}{\partial z}
            \end{equation}
            It would be good here to mention here that one of the Maxwell's equation uses divergence:
            $$\nabla\cdot \vec{B} = 0$$
            Another interpretation of this equation is ``No magnetic monopoles exist''.
